...
function twentyfifteen_entry_meta() {
	...
	if ( in_array( get_post_type(), array( 'post', 'attachment' ) ) ) {
		...
		printf( '<li class="icon fa-calendar posted-on"><span class="screen-reader-text">%1$s </span><a href="%2$s" rel="bookmark">%3$s</a></li>',
			_x( '', 'Used before publish date.', 'twentyfifteen' ),
	...
	if ( 'post' == get_post_type() ) {
		...
		if ( $categories_list && twentyfifteen_categorized_blog() ) {
			printf( '<li class="cat-links icon fa fa-clone"><span class="screen-reader-text">%1$s </span>%2$s</li>',
		...
		if ( $tags_list ) {
			printf( '<li class="tags-links icon fa-tags"><span class="screen-reader-text">%1$s </span>%2$s</li>',
				_x( '', 'Used before tag names.', 'twentyfifteen' ),
				$tags_list
			);
		}
	}
...
function twentyfifteen_excerpt_more( $more ) {
	$link = sprintf( '<a href="%1$s" class="button big more-link">%2$s</a>',
